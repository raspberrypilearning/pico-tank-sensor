...
--- task ---
Connect the **VCC** pin on the ultrasonic sensor to the power rail on the breadboard, and the **GND** pin to the ground rail. This will give the sensor power to operate.
